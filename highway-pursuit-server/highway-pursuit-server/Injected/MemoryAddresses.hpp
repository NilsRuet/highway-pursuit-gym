...
namespace Injected
{
    struct MemoryAddresses
    {
        ...
        // D3D8 offsets
        static const uint32_t CREATE_DEVICE_OFFSET = 0x492D0;
        static const uint32_t RESET_DEVICE_OFFSET = 0x29E50;
        static const uint32_t GET_DISPLAY_MODE_OFFSET = 0x2A650;
        static const uint32_t PRESENT_OFFSET = 0x2A260;
        static const uint32_t CREATE_SURFACE_IMAGE_OFFSET = 0x2B6F0;
        static const uint32_t GET_BACK_BUFFER_OFFSET = 0x2A1F0;
        static const uint32_t COPY_RECTS_OFFSET = 0x2A880;
        static const uint32_t GET_DESC_OFFSET = 0x27D30;
        static const uint32_t LOCK_RECT_OFFSET = 0x27E50;
        static const uint32_t UNLOCK_RECT_OFFSET = 0x27F30;
        static const uint32_t SURFACE_RELEASE_OFFSET = 0x24140;
        // DINPUT offsets
